...
public class InstallDocMgtImpl implements InstallDocMgt {
	...
	public String saveInstallDocDetail(String installDetailText) {
		InstallDocuDetail installDocuDetailUpdate = _gson.fromJson(
				installDetailText, InstallDocuDetail.class);

		int result = installDocuDetailMapper
				.updateByPrimaryKeySelective(installDocuDetailUpdate);
		return _helper.toJsonText(result, null);
	}
	...
	public String saveInstallDocument(String installDocumentText) {
		...
		int result = installDocumentMapper
				.updateByPrimaryKeySelective(installDocumentUpdate);
		return _helper.toJsonText(result, null);
	}
		...
		if (eventInfo != null) {
			try {
				...
				newInstallDocument.setCbelongtax(eventInfo
						.getEnterpriseBaseInfo().getCurrentTaxOrganization()
						.getCguid());
			} catch (Exception e) {
				e.printStackTrace();
			}
			...
			try {
				...
				if (currentInstallDocument != null) {
					...
					newInstallDocuDetail.setCcontactid(currentInstallDocument
							.getCcontactid());
					newInstallDocuDetail.setContactInfo(currentInstallDocument
							.getEnterpriseBaseInfo().getCurrentContact());
				}
